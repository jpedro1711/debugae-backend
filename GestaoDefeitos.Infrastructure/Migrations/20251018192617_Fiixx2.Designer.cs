...
namespace GestaoDefeitos.Infrastructure.Migrations
{
    ...
    [Migration("20251018192617_Fiixx2")]
    partial class Fiixx2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.DefectMailLetter", b =>
                {
                    b.Property<Guid>("DefectId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("DefectId", "ContributorId");

                    b.HasIndex("ContributorId");

                    b.ToTable("DefectMailLetters");
                });

            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.DefectRelation", b =>
                {
                    b.Property<Guid>("DefectId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("DefectId", "RelatedDefectId");

                    b.HasIndex("RelatedDefectId");

                    b.ToTable("DefectRelations");
                });

            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.Events.DefectChangeEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.TrelloUserStory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.DefectAttachment", b =>
                {
                    b.HasOne("GestaoDefeitos.Domain.Entities.Defect", "Defect")
                        .WithOne("Attachment")
                        .HasForeignKey("GestaoDefeitos.Domain.Entities.DefectAttachment", "DefectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.DefectMailLetter", b =>
                {
                    b.HasOne("GestaoDefeitos.Domain.Entities.Contributor", "Contributor")
                        .WithMany("DefectsSubscribedAtMailLetter")
                        .HasForeignKey("ContributorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GestaoDefeitos.Domain.Entities.Defect", "Defect")
                        .WithMany("ContributorMailLetter")
                        .HasForeignKey("DefectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.DefectRelation", b =>
                {
                    b.HasOne("GestaoDefeitos.Domain.Entities.Defect", "Defect")
                        .WithMany("RelatedDefects")
                        .HasForeignKey("DefectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GestaoDefeitos.Domain.Entities.Defect", "RelatedDefect")
                        .WithMany("RelatedToDefects")
            ...
            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.Contributor", b =>
                {
                    b.Navigation("DefectsAssignedTo");

                    b.Navigation("DefectsSubscribedAtMailLetter");
            ...
            modelBuilder.Entity("GestaoDefeitos.Domain.Entities.Defect", b =>
                {
                    ...
                    b.Navigation("ContributorMailLetter");

                    b.Navigation("DefectHistory");

                    b.Navigation("RelatedDefects");

                    b.Navigation("RelatedToDefects");

                    b.Navigation("Tags");

                    b.Navigation("TrelloUserStories");
                });
